...
import UpcomingProgram from '@/components/UpcomingProgram.vue'
import BlogRecommended from '@/components/BlogRecommended.vue'
...
.heart-icon {
  width: 24px;
  height: 24px;
  color: #ff8fa3; /* Soft pink for the heart */
}
